...
Transport.prototype.bumpHeartbeat = function () {
  ...
  this.brokerHeartbeat = setInterval(this.countdownBrokerHeartbeat, this.config.heartbeat.broker + this.config.heartbeat.grace);
}
...
Transport.prototype.setupClientHeartbeat = function () {
  ...
  this.clientHeartbeat = setInterval(this.sendHeartbeat, this.config.heartbeat.client / 2);
}
